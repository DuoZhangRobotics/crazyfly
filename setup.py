...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "crazyfly_all_drone_hover = tools.all_drone_hover:main",
            "crazyfly_fleet_hover = tools.all_drone_hover:main",
            ...
            "crazyfly_ur_trajectory = crazyfly.ur_trajectory_cli:main",
            "crazyfly_prrtc_demo = crazyfly.prrtc_demo:main",
        ],
    },
)
